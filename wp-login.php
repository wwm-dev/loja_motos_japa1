...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; Loja Motos &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acessar">
					...
					<p id="nav">
								<a href="/minha-conta/lost-password/">Perdeu a senha?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Ir para Loja Motos</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/loja-motos\/wp-admin\/admin-ajax.php"}};
</script>
<script src="/wp-includes/js/wp-util.min.js?ver=5.7.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"c3a7de7781"};
</script>
